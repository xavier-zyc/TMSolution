...
{
    public partial class OrderMap : TMSEntityTypeConfiguration<Order>
    {
        public OrderMap()
        {
            this.ToTable("Order");
            ...
            //code below is commented because it causes some issues on big databases - https://goo.gl/atUkcI
