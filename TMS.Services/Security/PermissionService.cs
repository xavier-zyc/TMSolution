...
namespace TMS.Services.Security
{
    /// <summary>
    /// Permission service
    /// </summary>
    public partial class PermissionService : IPermissionService
    {
        ...
        /// </remarks>
        private const string PERMISSIONS_ALLOWED_KEY = "TMS.permission.allowed-{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PERMISSIONS_PATTERN_KEY = "TMS.permission.";
        #endregion
