...
using TMS.Data;
using TMS.Services.Configuration;
using TMS.Services.Events;
using TMS.Services.Logging;
using TMS.Services.Seo;

namespace TMS.Services.Media
{
    /// <summary>
    /// Picture service
    /// </summary>
    public partial class PictureService : IPictureService
    {
            ...
            ResizeType resizeType = ResizeType.LongestSide, bool ensureSizePositive = true)
        {
            ...
            //we invoke Math.Round to ensure that no white background is rendered - https://goo.gl/qXmzbV
