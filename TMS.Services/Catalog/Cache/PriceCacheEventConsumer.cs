...
using TMS.core.Events;
using TMS.core.Infrastructure;
using TMS.Services.Events;

namespace TMS.Services.Catalog.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Order>>
    {
        ...
        /// {6} : current store ID
        /// </remarks>
        public const string PRODUCT_PRICE_MODEL_KEY = "TMS.totals.productprice-{0}-{1}-{2}-{3}-{4}-{5}-{6}";
        public const string PRODUCT_PRICE_PATTERN_KEY = "TMS.totals.productprice";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCT_CATEGORY_IDS_MODEL_KEY = "TMS.totals.product.categoryids-{0}-{1}-{2}";
        public const string PRODUCT_CATEGORY_IDS_PATTERN_KEY = "TMS.totals.product.categoryids";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCT_MANUFACTURER_IDS_MODEL_KEY = "TMS.totals.product.manufacturerids-{0}-{1}-{2}";
        public const string PRODUCT_MANUFACTURER_IDS_PATTERN_KEY = "TMS.totals.product.manufacturerids";
        ...
        public PriceCacheEventConsumer()
        {
            ...
            this._cacheManager = EngineContext.Current.ContainerManager.Resolve<ICacheManager>("TMS_cache_static");
        }
