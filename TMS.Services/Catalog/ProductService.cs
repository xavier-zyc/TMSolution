...
using TMS.Services.Localization;
using TMS.Services.Messages;
...
namespace TMS.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        /// {0} : product ID
        /// </remarks>
        private const string PRODUCTS_BY_ID_KEY = "TMS.product.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PRODUCTS_PATTERN_KEY = "TMS.product.";
        #endregion
