...
using TMS.core.Infrastructure.Mapper;
...
namespace TMS.core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class TMSEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(TMSConfig config)
        {
            ...
            builder.RegisterInstance(config).As<TMSConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(TMSConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(TMSConfig config)
        {
            //register dependencies
