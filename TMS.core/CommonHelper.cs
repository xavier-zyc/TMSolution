...
namespace TMS.core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new TMSException("邮件地址格式不正确.");
            }
        ...
        /// 设置一个对象的属性的值.
        /// </summary>
        /// <param name="instance">被设置属性的对象.</param>
        /// <param name="propertyName">被设置的属性.</param>
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new TMSException("该对象类型为{1}，并不包含属性{0}.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new TMSException("该对象类型为{1}，属性{0}不可写.", propertyName, instanceType);
            if (value != null && !value.GetType().IsAssignableFrom(pi.PropertyType))
                value = To(value, pi.PropertyType);
            pi.SetValue(instance, value, new object[0]);
        }

        public static TypeConverter GetTMSCustomTypeConverter(Type type)
        {
        ...
        public static object To(object value, Type destinationType, CultureInfo culture)
        {
            if (value != null)
            {
                ...
                TypeConverter destinationConverter = GetTMSCustomTypeConverter(destinationType);
                TypeConverter sourceConverter = GetTMSCustomTypeConverter(sourceType);
