...
namespace TMS.core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into TMSolution, 
                ...
                //The issue is described here: https://goo.gl/wV6jzx
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here https://goo.gl/AKYtGD
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new TMSException("TMSolution needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["TMS.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["TMS.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["TMS.IsPOSTBeingDone"] = value;
            }
        }
