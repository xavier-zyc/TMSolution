...
{
    public partial class TMSConfig : IConfigurationSectionHandler
    {
        public object Create(object parent, object configContext, XmlNode section)
        {
            var config = new TMSConfig();
            ...
            var supportPreviousTMSolutionVersionsNode = section.SelectSingleNode("SupportPreviousTMSolutionVersions");
            config.SupportPreviousTMSolutionVersions = GetBool(supportPreviousTMSolutionVersionsNode, "Enabled");
        ...
        /// <summary>
        /// Indicates whether we should support previous TMSolution versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousTMSolutionVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during TMSolution installation
        /// </summary>
